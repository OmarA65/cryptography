...
namespace Security_project
{
    public partial class Form1 : Form
    {
        ...
        void RC4_Encryption()
        {
            ...
            k = textBox1.Text.ToCharArray();
            plain = textBox2.Text.ToCharArray();
            int[] T = { int.Parse(k[0].ToString()), int.Parse(k[1].ToString()), int.Parse(k[2].ToString()), int.Parse(k[3].ToString()), int.Parse(k[0].ToString()), int.Parse(k[1].ToString()), int.Parse(k[2].ToString()), int.Parse(k[3].ToString()) };
            int[] p = { int.Parse(plain[0].ToString()), int.Parse(plain[1].ToString()), int.Parse(plain[2].ToString()), int.Parse(plain[3].ToString()) };
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                ...
                if (comboBox1.SelectedIndex == 2)
                {
                    ...
                    {
                        MessageBox.Show("Check the key should be 4 bit or the plaintext should be 4 bit");
                ...
                {
                    textBox3.Text = pf.encryption(textBox2.Text.Trim(), textBox1.Text.Trim());
                }
                ...
                if (comboBox1.SelectedIndex == 3)
                {
                    if (ValidateRSAInput())
                    {
                        int p = int.Parse(rsapInput.Text);
                        int q = int.Parse(rsaqInput.Text);
                        int rsae = int.Parse(rsaeInput.Text);
                        int m = int.Parse(rsamcInput.Text);

                        textBox3.Text = rsa.Encrypt(p, q, rsae, m);
                    }
                }
            }
            if (radioButton2.Checked)
            {
                ...
                if (comboBox1.SelectedIndex == 4)
                {
                    textBox3.Text = pf.Decryption(textBox2.Text.Trim(), textBox1.Text.Trim());
                }
                ...
                if (comboBox1.SelectedIndex == 3)
                {
                    if(ValidateRSAInput())
                    {
                        ...
                        int q = int.Parse(rsaqInput.Text);
                        int rsae = int.Parse(rsaeInput.Text);
                        int c = int.Parse(rsamcInput.Text);

                        textBox3.Text = rsa.Decryption(p, q, rsae, c);
                    }
                }
            }
        ...
        public bool ValidateRSAInput()
        {
            if (string.IsNullOrEmpty(rsapInput.Text))
            {
                MessageBox.Show("Enter all required inputs");
                return false;
            }
            if (string.IsNullOrEmpty(rsaqInput.Text))
            {
                MessageBox.Show("Enter all required inputs");
                return false;
            }
            if (string.IsNullOrEmpty(rsaeInput.Text))
            {
                MessageBox.Show("Enter all required inputs");
                return false;
            }
            if (string.IsNullOrEmpty(rsamcInput.Text))
            {
                MessageBox.Show("Enter all required inputs");
                return false;
            }
